...
class SDK_transform(object):
    ...
    def transform_script(self, file_path, file_type, json_rpc_context = None):
        if json_rpc_context and type(json_rpc_context) is not dict:
            raise ValueError('Method transform_script: argument json_rpc_context is not type dict as required.')
        resp = self._call('SDK_transform.transform_script',
