...
function SDK_transform(url, auth, auth_cb, timeout, async_job_check_time_ms, async_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.transform_script = function (file_path, file_type, _callback, _errorCallback) {
        ...
        return json_call_ajax("SDK_transform.transform_script",
